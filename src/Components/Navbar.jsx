...
const Navbar = () => {
  return (
    <div className="max-w-fit px-10 py-5 h-screen border-r-2  border-r-gray-400  bg-amber-100">

      {/* <div className="flex flex-col h-full background justify-between"> */}
      <div className="h-full">
        {/* logo section  */}
        <div className="m-2 border-b-2 border-dotted  w-full border-b-gray-400">
          <Link to={'/'}><h1 className="pb-1 font-bold text-2xl"> <span className="text-sky-600 ">Blue</span>Ocean</h1></Link>
          </div>

        <nav className="flex flex-col justify-around w-fit text-[1.1em]  h-full">
